package com.Jvnyor.bds04.controllers;
...
import com.Jvnyor.bds04.tests.TokenUtil;
...
public class EventControllerIT {
	...
	public void insertShouldReturn422WhenAdminLoggedAndPastDate() throws Exception {
		...
		result.andExpect(jsonPath("$.errors[0].message").value("A data do evento nao pode ser passada"));
	}
